    ...
    <AnimatePresence>
      {lastCompletedTask && (
        <motion.div
          ...
          className="fixed bottom-20 md:bottom-10 left-1/2 -translate-x-1/2 z-50 flex items-center gap-4 bg-[#1c1c1e] border border-white/10 rounded-xl px-4 py-3 shadow-2xl"
        >
